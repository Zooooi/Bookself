...
:: Android packaging
set AND_CERT_NAME="bookself"
set AND_CERT_PASS=JasonLee456852
set AND_CERT_FILE=D:\JasonLee\Develop\apps\Jason p12\JasonLee_Android.p12
...
set IOS_PROVISION=cert\bookself.mobileprovision
...
set APP_ID=air.bookself

:: Output packages
set DIST_PATH=dist
set DIST_NAME=bookself
